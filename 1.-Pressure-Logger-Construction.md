...
* Using the 3M Scotch-Weld Acrylic Adhesive, glue the assembled pressure sensor stack to the 3/4" PVC pipe. 

<insert image here> 

* Once the assembled pressure sensor stack has been glued into 3/4" Schedule 40 PVC, prepare the glue the pressure logger PVC to the PVC housing the carrier board. 
